...
def match_combo_with_AST(ast1, combo1, ast2, combo2, algo_name):
  ...
  if algo_name == "structure_only":
    result = d_ast_match_util_apted.editdis_mapping_naive1(sourceAPTEDStr, targetAPTEDStr, verbose=False)
    ...
    result = d_ast_match_util_apted.editdis_mapping_naive2(
...
def distance_of_AST_frags(frag1, frag2, algo_name):
  ...
  distval = d_ast_match_util_apted.editdis_naive2(
    aptedStr1, aptedStr2,
