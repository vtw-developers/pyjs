...
class TranslateAny:
  ...
  class Prompt:
    ...
    DIRECT_TRANS_WITH_REFERENCE = (
      ...
      '\n'
      '\n'
      '<<<end of reference information section>>>\n'
      '\n'
      '\n'
      '<<<task section>>>\n'
      '\n'
      'Translate the following {src_language} snippet into a semantically equivalent {tar_language} snippet:\n'
      '```{src_language}\n'
      '{program_to_translate}\n'
      '```\n'
      ...
      '2. **Translated {tar_language} Codes**:\n'
      '   Output each final {tar_language} code.\n'
      '\n'
      'Constraints:\n'
