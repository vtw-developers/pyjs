...
var findRedundantDirectedConnection = function(edges) {
    ...
    return conflict === -1 ? edges[cycle] : cycle === -1 ? edges[conflict] : [parents[edges[conflict][1]], edges[conflict][1]];
    ...
    function union(x, y) {
        ...
        rank[px] < rank[py] ? parent[px] = py : rank[px] > rank[py] ? parent[py] = px : (parent[py] = px, rank[px]++);
        return true;
    }
};